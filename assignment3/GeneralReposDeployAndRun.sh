...
sshpass -f password scp config.sh $USER@$GRH:/home/$USER
sshpass -f password ssh $USER@$GRH 'source config.sh ; cd test/GameOfRope/dirGeneralRepos ; ./repos_com_d.sh '$USER''
