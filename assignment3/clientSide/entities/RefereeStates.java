...
/**
 * The RefereeStates enum represents the possible states of a referee in the
 * game simulation.
 * Referees can be in one of the following states: START_OF_THE_MATCH,
...
public enum RefereeStates {
    ...
    /**
     * Represents the state where the referee is waiting for the conclusion of a
     * trial.
     */
