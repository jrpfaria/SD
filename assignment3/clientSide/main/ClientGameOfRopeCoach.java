...
/**
 * Client side of the Game Of Rope (coaches).
 *
...
public class ClientGameOfRopeCoach {
    ...
    public static void main(String[] args) {
        ...
        Coach[] coach = new Coach[2]; // array of coach threads
        ...
        try {
            ...
            GenericIO.writelnString(
                    "Coach generator remote exception on ContestantsBench shutdown: " + e.getMessage());
            System.exit(1);
        }
        try {
            reposStub.shutdown();
            ...
            GenericIO
                    .writelnString("Coach generator remote exception on GeneralRepos shutdown: " + e.getMessage());
            System.exit(1);
        }
    }
}
