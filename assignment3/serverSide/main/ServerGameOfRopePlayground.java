...
public class ServerGameOfRopePlayground {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            GenericIO.writelnString("The data type ServerGameOfRopePlayground was not found (blocking)!");
            e.printStackTrace();
            System.exit(1);
        }
    ...
    public static void shutdown() {
        ...
        try {
            ...
            GenericIO.writelnString("The data type ServerGameOfRopePlayground was not found (waking up)!");
            e.printStackTrace();
            System.exit(1);
        }
    }
