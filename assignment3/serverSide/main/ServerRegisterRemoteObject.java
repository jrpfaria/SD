...
/**
 * Instantiation and registering of an object that enables the registration of
 * other objects located
 * in the same or other processing nodes of a parallel machine in the local RMI
 * registry service.
 *
...
public class ServerRegisterRemoteObject {
  ...
  public static void main(String[] args) {
    ...
    RegisterRemoteObject regEngine = new RegisterRemoteObject(rmiRegHostName, rmiRegPortNumb); // object that enables
                                                                                               // the registration
                                                                                               // of other remote
                                                                                               // objects
