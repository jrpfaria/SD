...
public class ServerGameOfRopeContestantsBench {
    ...
    public static void main(String[] args) {
        ...
        try {
            while (!end)
                synchronized (Class.forName("serverSide.main.ServerGameOfRopeContestantsBench")) {
                    try {
                        (Class.forName("serverSide.main.ServerGameOfRopeContestantsBench")).wait();
                    } catch (InterruptedException e) {
                        GenericIO.writelnString("Contestants Bench main thread was interrupted!");
                    }
                }
        } catch (ClassNotFoundException e) {
            GenericIO.writelnString("The data type ServerGameOfRopeContestantsBench was not found (blocking)!");
            e.printStackTrace();
            System.exit(1);
        }
    ...
    public static void shutdown() {
        ...
        try {
            synchronized (Class.forName("serverSide.main.ServerGameOfRopeContestantsBench")) {
                (Class.forName("serverSide.main.ServerGameOfRopeContestantsBench")).notify();
            }
        } catch (ClassNotFoundException e) {
            GenericIO.writelnString("The data type ServerGameOfRopeContestantsBench was not found (waking up)!");
            e.printStackTrace();
            System.exit(1);
        }
    }
