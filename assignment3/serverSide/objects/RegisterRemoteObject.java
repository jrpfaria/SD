...
public class RegisterRemoteObject implements Register {
   /**
    * Name of the local host (where the RMI registering service is supposed to be
    * located).
    */
    ...
    * @param rmiRegPortNumb port number where the local registering service is
    *                       listening to
    */
    ...
    *                               or the communication with the registry
    *                               service fails
    ...
    *                           the communication with the registry
    *                           service fails
