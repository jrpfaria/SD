...
/**
 * The Pair class is used to represent a key-value pair that can be compared to
 * other instances by value, which makes it useful for sorting information.
 *
...
public class Pair<X, Y extends Comparable<Y>> implements Comparable<Pair<X, Y>>, Serializable {
     ...
     * @return a negative integer, zero, or a positive integer as this Pair's value
     *         is less than, equal to, or greater than the specified Pair's value.
     */
