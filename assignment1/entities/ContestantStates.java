...
public enum ContestantStates {
    ...
    /**
     * Represents the state where the contestant is standing in position on the playground.
     */
    STAND_IN_POSITION,

    /**
     * Represents the state where the contestant is performing their best in the trial.
     */
    DO_YOUR_BEST;
