...
cp clientSide/main/ClientGameOfRopeBarber.class dirReferee/clientSide/main
cp clientSide/entities/Barber.class clientSide/entities/BarberStates.class dirReferee/clientSide/entities
cp clientSide/stubs/GeneralReposStub.class clientSide/stubs/BarberShopStub.class dirReferee/clientSide/stubs
...
cp clientSide/main/ClientGameOfRopeBarber.class dirCoaches/clientSide/main
cp clientSide/entities/Barber.class clientSide/entities/BarberStates.class dirCoaches/clientSide/entities
cp clientSide/stubs/GeneralReposStub.class clientSide/stubs/BarberShopStub.class dirCoaches/clientSide/stubs
cp commInfra/Message.class commInfra/MessageType.class commInfra/MessageException.class commInfra/ClientCom.class dirCoaches/commInfra
echo "  Contestants"
...
cp clientSide/main/ClientGameOfRopeBarber.class dirContestants/clientSide/main
cp clientSide/entities/Barber.class clientSide/entities/BarberStates.class dirContestants/clientSide/entities
cp clientSide/stubs/GeneralReposStub.class clientSide/stubs/BarberShopStub.class dirContestants/clientSide/stubs
