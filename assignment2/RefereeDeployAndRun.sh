...
sshpass -f password ssh sd102@l040101-ws07.ua.pt 'cd test/GameOfRope/dirReferee ; java clientSide.main.ClientGameOfRopeReferee l040101-ws01.ua.pt 22110 l040101-ws02.ua.pt 22110 l040101-ws05.ua.pt 22110'
