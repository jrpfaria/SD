...
sshpass -f password ssh sd102@l040101-ws09.ua.pt 'cd test/GameOfRope/dirContestants ; java clientSide.main.ClientGameOfRopeContestants l040101-ws01.ua.pt 22110 l040101-ws02.ua.pt 22110 l040101-ws05.ua.pt 22110'
